...
images_path="C:\\Users\\Panos2\\Desktop\\Materiasl\\ACG\\Machine Vision\\Python\\sign_language\\Images"
    ...
    #Time to configure the hand specifically into the ROI...
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 100:
                ...
                #cv2.imwrite("D:\\gesture\\x"+"\\" + str(num_imgs_taken) + '.jpg', thresholded)
                cv2.imwrite(f"Images\\test\\zero\\{image_pictures_taken}_" + str(num_imgs_taken) + '.jpg', thresholded)
            else:
                break
            num_imgs_taken +=1
        else:
